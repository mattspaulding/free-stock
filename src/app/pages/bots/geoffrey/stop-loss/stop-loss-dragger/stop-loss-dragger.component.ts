...
@Component({
  selector: 'ngx-stop-loss-dragger',
  templateUrl: './stop-loss-dragger.component.html',
  styleUrls: ['./stop-loss-dragger.component.scss'],
})
export class StopLossDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = StopLossDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
